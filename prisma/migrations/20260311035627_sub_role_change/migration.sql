/*
  ...
  - The values [head,member] on the enum `SubRole` will be removed. If these variants are still used in the database, this will fail.

*/
-- AlterEnum
BEGIN;
CREATE TYPE "SubRole_new" AS ENUM ('DG', 'HEAD', 'SECRETARY', 'STAFF');
